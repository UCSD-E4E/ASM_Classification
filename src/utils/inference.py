...
def inference_func(load_n_test, video_file, seed, output_csv_path):
    ...
    val_transform = transforms.Compose([transforms.CenterCrop(100),transforms.ToTensor(),transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
    dataset_test = AyeAyeDatasetInference(video_file=video_file, transforms=val_transform)
...
#     parser.add_argument("--video_file", type=str, default = '/home/burrowingowl/asm-nas/processed_data')
